...
public class ThinDashedLinedTriangle extends Shape {
    private static final int TRIANGLE_CORNERS = 4;

    public ThinDashedLinedTriangle() {
        this.corners = TRIANGLE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + ThinDashedLinedTriangle.class.getSimpleName());
