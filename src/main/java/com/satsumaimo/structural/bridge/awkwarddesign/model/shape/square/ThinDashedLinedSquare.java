...
public class ThinDashedLinedSquare extends Shape {
    private static final int SQUARE_CORNERS = 4;
    public ThinDashedLinedSquare() {
        this.corners = SQUARE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + ThinDashedLinedSquare.class.getSimpleName());
