...
public class ThinDoubleLinedSquare extends Shape {
    private static final int SQUARE_CORNERS = 4;
    public ThinDoubleLinedSquare() {
        this.corners = SQUARE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + ThinDoubleLinedSquare.class.getSimpleName());
