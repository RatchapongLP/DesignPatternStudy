...
public class MediumContinuousLinedTriangle extends Shape {
    private static final int TRIANGLE_CORNERS = 4;

    public MediumContinuousLinedTriangle() {
        this.corners = TRIANGLE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + MediumContinuousLinedTriangle.class.getSimpleName());
