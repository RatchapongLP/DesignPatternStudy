...
public class ThinContinuousLinedSquare extends Shape {
    private static final int SQUARE_CORNERS = 4;
    public ThinContinuousLinedSquare() {
        this.corners = SQUARE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + ThinContinuousLinedSquare.class.getSimpleName());
