...
public class ThickDoubleLinedSquare extends Shape {
    private static final int SQUARE_CORNERS = 4;
    public ThickDoubleLinedSquare() {
        this.corners = SQUARE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + ThickDoubleLinedSquare.class.getSimpleName());
