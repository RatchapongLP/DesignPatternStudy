...
public class MediumDoubleLinedTriangle extends Shape {
    private static final int TRIANGLE_CORNERS = 4;

    public MediumDoubleLinedTriangle() {
        this.corners = TRIANGLE_CORNERS;
    }

    @Override
    public void kickStart() {
        System.out.println("Kick starting " + MediumDoubleLinedTriangle.class.getSimpleName());
